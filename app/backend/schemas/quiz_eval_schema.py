...
class quiz_evaluation(BaseModel):
    ...
    improvement_tips: str = Field("Improvement learning tips for user based on quiz in brief with resources tips in brief tell user what they did wrong show comaparsion explananiton in 400-500 chars don't include any links here just give tips and feedback for improvement")
